...
= Installation
  ...
  4. cd to `plugins`
  5. Clone the scrummer plugin `git clone -b rails_3 https://github.com/mahkhaled/redmine_scrummer.git`
  6. Run `rake redmine:plugins:migrate`
  7. Run `redmine_scrummer:load_default_data`
